...
function bracketDeco(state) {
  ...
  for (let range of state.selection.ranges) {
    ...
    if (match)
      decorations = decorations.concat(config2.renderMatch(match, state));
  }
...
var completeAnyWord = (context) => {
  var _a2;
  let wordChars = (_a2 = context.state.languageDataAt("wordChars", context.pos)[0]) !== null && _a2 !== void 0 ? _a2 : "";
...
//# sourceMappingURL=chunk-2TOXHZ3J.js.map
