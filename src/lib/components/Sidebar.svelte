...
<aside class="flex shrink-0 flex-col border-r border-quiet-border/70 bg-quiet-surface/40 transition-[width] duration-200 ease-in-out {$sidebarCollapsed ? 'w-10' : 'w-64'}">
  {#if !$sidebarCollapsed}
