...
{#if open}
  ...
  >
    ...
    >
      ...
      <!-- Tabs -->
      <div class="flex border-b border-quiet-border/60 px-5" role="tablist">
        <button
          role="tab"
          aria-selected={activeTab === 'outgoing'}
          id="backlinks-tab-outgoing"
      ...
      <!-- Body -->
      <div class="min-h-0 flex-1 overflow-y-auto p-4" role="tabpanel" aria-labelledby="backlinks-tab-{activeTab}">
